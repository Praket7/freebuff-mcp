...
export class ProgressStore {
  private byThread = new Map<string, Entry[]>(); private waiters = new Map<string, Set<() => void>>(); private seq = new Map<string, number>(); private connected = false; private lastEventAt = 0;
