...
export function createServer(runtime: Runtime, includeWrites = true, allowedWrites = new Set(['send_message','stop_thread','resume_thread','set_model','set_reasoning'])): McpServer { const s=new McpServer({name:'freebuff-mcp',version:'0.1.17'});
